...
const settings = {
  creatorName: "X-Gilzz",
  apiTitle: "TB API's",
  channelLink: "https://chat.whatsapp.com/DUBRJrgGzkqIaMapvEmt8p", 
  githubLink: "https://chat.whatsapp.com/DUBRJrgGzkqIaMapvEmt8p", 
  contactLink: "https://wa.me/628567909841"
};
  ...
  res.json = function (data) {
    if (
      ...
      return originalJson.call(this, {
        creator: settings.creatorName || "Created Using X-Gilzz",
        ...data
      });
    }
